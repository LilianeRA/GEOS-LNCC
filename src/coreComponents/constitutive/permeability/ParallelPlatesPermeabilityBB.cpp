...
/**
 * @file ParallelPlatesPermeabilityBB.cpp
 */

#include "ParallelPlatesPermeabilityBB.hpp"
...
ParallelPlatesPermeabilityBB::ParallelPlatesPermeabilityBB( string const & name, Group * const parent ):
...
ParallelPlatesPermeabilityBB::deliverClone( string const & name,
                                          Group * const parent ) const
{
  return PermeabilityBase::deliverClone( name, parent );
}

void ParallelPlatesPermeabilityBB::allocateConstitutiveData( dataRepository::Group & parent,
...
void ParallelPlatesPermeabilityBB::initializeState() const
{
...
REGISTER_CATALOG_ENTRY( ConstitutiveBase, ParallelPlatesPermeabilityBB, string const &, Group * const )
