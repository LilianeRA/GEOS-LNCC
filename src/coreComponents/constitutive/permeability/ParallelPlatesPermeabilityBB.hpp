...
/**
 * @file ParallelPlatesPermeabilityBB.hpp
 */

#ifndef GEOS_CONSTITUTIVE_PERMEABILITY_PARALLELPLATESPERMEABILITYBB_HPP_
#define GEOS_CONSTITUTIVE_PERMEABILITY_PARALLELPLATESPERMEABILITYBB_HPP_
...
class ParallelPlatesPermeabilityBBUpdate : public PermeabilityBaseUpdate
{
public:

  ParallelPlatesPermeabilityBBUpdate( arrayView3d< real64 > const & permeability,
...
class ParallelPlatesPermeabilityBB : public PermeabilityBase
{
public:

  ParallelPlatesPermeabilityBB( string const & name, Group * const parent );
  ...
  static string catalogName() { return "ParallelPlatesPermeabilityBB"; }
  ...
  using KernelWrapper = ParallelPlatesPermeabilityBBUpdate;
...
#endif //GEOS_CONSTITUTIVE_PERMEABILITY_PARALLELPLATESPERMEABILITYBB_HPP_
